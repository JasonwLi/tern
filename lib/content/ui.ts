...
export const contentUi: Record<Locale, ContentUi> = {
  ...
  pt: {
    guidesNav: "Guias",
    blogNav: "Blog",
    guidesTitle: "Guias de working holiday",
    guidesIntro: "Guias práticos e sem enrolação sobre dinheiro, impostos e vistos para o seu working holiday.",
    blogTitle: "O blog da Tern",
    blogIntro: "Dicas e análises para fazer o seu dinheiro render mais na viagem.",
    readMore: "Leia mais",
    minRead: "{n} min de leitura",
    backToGuides: "Todos os guias",
    backToBlog: "Todos os posts",
    related: "Leia também",
    ctaTitle: "Chegue com tudo resolvido",
    ctaText: "A Tern é o banco digital pensado para o working holiday — entre na lista de espera.",
    ctaButton: "Entrar na lista de espera",
    home: "Início",
    sourcesTitle: "Fontes",
    disclaimer: "Este guia é informação geral, não é consultoria financeira nem de imigração. Regras e valores mudam — confira sempre as fontes oficiais acima.",
    statusNav: "Ver minha posição",
    statusTitle: "Confira sua posição na lista de espera",
    statusIntro: "Digite o e-mail usado no cadastro para ver sua posição e quantos amigos você indicou.",
    statusCheck: "Ver minha posição",
    statusChecking: "Verificando…",
    statusNotFound: "Esse e-mail não está na lista de espera — cadastre-se primeiro!",
    statusPosition: "Sua posição",
    statusReferrals: "Amigos indicados",
    guidesGroupEurope: "Reino Unido e Europa",
    guidesGroupEssentials: "Básico de dinheiro",
    guidesGroupDeparture: "Antes de sair do seu país",
  },
  de: {
    guidesNav: "Ratgeber",
    blogNav: "Blog",
