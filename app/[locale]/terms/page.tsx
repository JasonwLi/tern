...
const SECTIONS: { h: string; ps: string[] }[] = [
  ...
  },
  {
    ...
    ps: [
      ...
      "Early-position perks — such as Founding Member benefits (a period of fee-free currency swaps) for the first 500 positions, or a complimentary personalised metal card for the first 1,000 — describe our current intentions for launch. They are conditional on Tern launching in your market, may be modified before launch, have no monetary value before launch, and may be withdrawn in cases of abuse.",
    ],
  },
  {
    h: "Acceptable use",
